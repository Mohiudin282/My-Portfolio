                ...
                <div className="grid gap-4">
                    <div className="grid gap-1">
                        ...
                        <p className="text-muted-foreground">
                            I'm a final-year <span className="font-bold">Computer Science</span> student. I'm kickstarting my career as a web developer because the web is becoming more diverse day by day.
                        </p>
                    </div>
                    <div className="grid gap-1">
